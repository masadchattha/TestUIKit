...
@IBDesignable public class HBSegmentedControl: UIControl {
    ...
    @IBInspectable public var selectedLabelColor: UIColor = UIColor.red {
    ...
    @IBInspectable public var thumbColor: UIColor = UIColor(named: "LightRedBrickColor") ?? .black {
        didSet { setSelectedColors() }
    }
    ...
    private func setupView() {
        ...
        layer.borderColor = UIColor(white: 0.0, alpha: 0.3).cgColor
        layer.borderWidth = 1
